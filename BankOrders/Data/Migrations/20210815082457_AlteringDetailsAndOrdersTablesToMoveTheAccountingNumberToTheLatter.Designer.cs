...
namespace BankOrders.Data.Migrations
{
    ...
    [Migration("20210815082457_AlteringDetailsAndOrdersTablesToMoveTheAccountingNumberToTheLatter")]
    partial class AlteringDetailsAndOrdersTablesToMoveTheAccountingNumberToTheLatter
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankOrders.Data.Models.Order", b =>
                {
                    ...
                    b.HasIndex("UserApprovePostingId");

                    b.HasIndex("UserCreateId");

                    b.HasIndex("UserPostingId");
            ...
            modelBuilder.Entity("BankOrders.Data.Models.Order", b =>
                {
                    b.HasOne("BankOrders.Data.Models.User", "UserApprove")
                        .WithMany()
                        .HasForeignKey("UserApproveId");

                    b.HasOne("BankOrders.Data.Models.User", "UserApprovePosting")
                        .WithMany()
                        .HasForeignKey("UserApprovePostingId");

                    b.HasOne("BankOrders.Data.Models.User", "UserCreate")
                        .WithMany()
                        .HasForeignKey("UserCreateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BankOrders.Data.Models.User", "UserPosting")
                        .WithMany()
                        .HasForeignKey("UserPostingId");

                    b.Navigation("UserApprove");

                    b.Navigation("UserApprovePosting");

                    b.Navigation("UserCreate");

                    b.Navigation("UserPosting");
                });
